...
//declaracion de variables 
		Double medicinageneral, pediatria, traumatologia, neumologia, ginecologia;
	//entrada de datos
		double donacion = Double.parseDouble(txtDonacionSoles.getText());
		//proceso
		medicinageneral = donacion * 0.17;
		pediatria = donacion * 0.35;
		traumatologia = donacion * 0.23;
		neumologia = donacion * 0.15;
		ginecologia = donacion * 0.10;
		//salida de resultados
		txtS.setText("Reparto de Donacion \n \n ");
		
		txtS.append("MedicinaGeneral :" + medicinageneral +"\n");
		txtS.append("Pediatria       :" + pediatria +" \n ");
		txtS.append("Traumatologia   :" + traumatologia+"\n");
		txtS.append("Neumologia      :" + neumologia+"\n");
		txtS.append("Ginecologia     :" + ginecologia );
