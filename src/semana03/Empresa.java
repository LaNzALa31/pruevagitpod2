...
public class Empresa extends JFrame implements ActionListener {
 ...
 double monto, contabilidad, marketing, informatica, produccion, soporte;
		//entrada de datos
 monto = Double.parseDouble(txtMontoDinero.getText());
        //procesos
  contabilidad = monto *0.25;
  marketing = monto * 0.18;
  informatica = monto * 0.31;
  produccion = monto * 0.33;
  soporte = monto * 0.12 ;
  //SALIDA DE RESULTADOS
  txtS.setText("Reparto de dinero \n");
  
  txtS.append("Contabilidad: "+ contabilidad +"\n" );
  txtS.append("Marketing: "+ marketing +"\n");
  txtS.append("Informatica: "+ informatica +"\n");
  txtS.append("Produccion: "+ produccion +"\n" );
