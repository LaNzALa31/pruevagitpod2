...
public class Empresa extends JFrame implements ActionListener {
	...
	public Empresa() {
		...
		btnBorrar.setBounds(335, 52, 89, 23);
	...
	protected void actionPerformedBtnProcesar(ActionEvent arg0){
		...
		String sheraton;
		 ...
		 double utilidad;
	//ENTRADA DE DATOS
		sheraton = txtRazonSocial.getText();
		empleados = Integer.parseInt(txtNumeroEmpleados.getText());
	...
	//SALIDA DE RESULTADOS
		txtS.setText("DATOS INGREADOS \n");
		
		txtS.append("RAZON SOCIAL :"+ sheraton +"\n");
		txtS.append("NUMERO DE EMPLEADOS :"+ empleados +"\n");
		txtS.append("UTILIDAD ANUAL:"+utilidad);
	}
